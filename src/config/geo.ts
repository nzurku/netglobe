...
// Cable routes built from local TeleGeography data files (src/data/).
// To change which cables appear, edit SELECTED_CABLE_IDS in src/services/cable-routes.ts.
import { buildCableRoutes } from '@/services/cable-routes';
export const UNDERSEA_CABLES: UnderseaCable[] = buildCableRoutes();
