...
const TECH_PANELS: Record<string, PanelConfig> = {
  ...
  ai: { name: 'AI/ML News', enabled: false, priority: 1 },
  tech: { name: 'Technology', enabled: false, priority: 1 },
  ...
  regulation: { name: 'AI Regulation Dashboard', enabled: false, priority: 1 },
  layoffs: { name: 'Layoffs Tracker', enabled: false, priority: 1 },
  markets: { name: 'Tech Stocks', enabled: true, priority: 2 },
  finance: { name: 'Financial News', enabled: false, priority: 2 },
  crypto: { name: 'Crypto', enabled: true, priority: 2 },
  ...
  ipo: { name: 'IPO & SPAC', enabled: false, priority: 2 },
  polymarket: { name: 'Tech Predictions', enabled: false, priority: 2 },
  ...
  'runtime-config': { name: 'Desktop Configuration', enabled: true, priority: 2 },
  economic: { name: 'Economic Indicators', enabled: false, priority: 2 },
  'tech-readiness': { name: 'Tech Readiness Index', enabled: false, priority: 1 },
  'macro-signals': { name: 'Market Radar', enabled: true, priority: 2 },
